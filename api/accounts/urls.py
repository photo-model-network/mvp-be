...
from .views import FavoriteArtistManageView, ListFavoriteArtistsView, NameDuplicateCheckView
...
urlpatterns = (
    ...
    + [
        ...
        path('accounts/name-duplicheck/', NameDuplicateCheckView.as_view(), name='name_duplicate_check'),    
    ]
)

...
schema_view = get_schema_view(
    openapi.Info(
        title="PHOTO API",
        default_version="v1",
        contact=openapi.Contact(email="madeffort0903@gmail.com"),
        license=openapi.License(name="Hyunwoo Kim"),
    ),
    public=True,
...
today_datetime = datetime.now(settings.KST).date()
...
api_urlpatterns = [
    ...
    path("api/", include("api.studios.urls")),
]
